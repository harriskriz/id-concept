        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-6 text-lg md:text-xl leading-relaxed">
            <p className="text-textSecondary">
              We specialize in creating acoustically refined, serene environments that combine luxury with tranquility. Our expertise transforms spaces into sanctuaries of unparalleled peace and sophistication.
            </p>
